...
func execute(command: Command) -> void:
	...
	EventController.push_event("event:command_executed", [command])
...
func undo() -> void:
	...
	EventController.push_event("event:command_undone")
...
func redo() -> void:
	...
	EventController.push_event("event:command_redone")
